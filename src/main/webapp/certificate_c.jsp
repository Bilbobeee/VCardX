...
<body>
	...
	<div>
		<div class="image-container-rename-1">
			<img class="image-call-rename-1"
				src="${pageContext.request.contextPath}/certificate/sans_pen.png"
				alt="Image Call1">
			<div class="additional-image-rename-1"></div>
		</div>
	</div>

	<div>
		<div class="mimage-container-rename-1">
			<img class="image-call-cy-certificate-1"
				src="${pageContext.request.contextPath}/certificate/resilience.png"
				alt="Image Call333">
			<div class="additional-image-cy-certificate-1"></div>
		</div>
	</div>
